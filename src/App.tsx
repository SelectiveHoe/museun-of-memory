  ...
  return (
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid  grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
        {appConfig.map(({firstName,iconPath,lastName, description, years}) => {
          const fullName = `${firstName} ${lastName}`;
          return (
            <Card key={fullName} title={fullName} imgSrc={"/museum-of-memory/" + iconPath} description={description} years={years} />
      )})}
      </div>
    </div>
    </div></div>
